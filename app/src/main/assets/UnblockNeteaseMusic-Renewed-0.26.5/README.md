...
fork 自 [1715173329的版本](https://github.com/1715173329/UnblockNeteaseMusic)，仅作部分优化。十分感谢 nondanee 提供如此棒的工具，1715173329的优化！

## 特性

- 使用 Bilibili / QQ / ~~百度~~ / 酷狗 / 酷我 / 咪咕 / ~~JOOX~~ / Youtube 等音源替换变灰歌曲链接 (默认仅启用一、二、五、八)
...
```bash
git clone https://github.com/1582421598/UnblockNeteaseMusic-Renewed
...
| 变量名称    | 类型 | 描述                                   | 示例                                                             |
| ----------- | ---- | -------------------------------------- | ---------------------------------------------------------------- |
|     VIP     | bool | 启用/禁用本地黑胶VIP                   | `VIP=true`                                                       |
...
```javascript
const match = require('@1582421598/unblockneteasemusic');
